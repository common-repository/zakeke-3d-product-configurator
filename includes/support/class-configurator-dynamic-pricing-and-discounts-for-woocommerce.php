 ...
 */
class ZakekeConfigurator_Support_Dynamic_Pricing_And_Discounts_For_Woocommerce {

    /**
     * Hook in Zakeke support handlers.
     */
    public static function init() {
        add_action( 'zakeke_configurator_before_ajax_price', array( __CLASS__, 'set_quantity' ), 10, 2 );
    }
...
ZakekeConfigurator_Support_Dynamic_Pricing_And_Discounts_For_Woocommerce::init();
